    ...
    public class PosteService
{
        ...
        public async Task<Poste> GetPosteById(int posteId)
        {
            ...
            HttpResponseMessage response = await _httpClient.GetAsync($"https://localhost:7011/api/Postes/{posteId}");
            response.EnsureSuccessStatusCode();
        ...
        public async Task AddPoste(Poste poste)
        {
            ...
            var response = await _httpClient.PostAsync("https://localhost:7011/api/Postes", content);
            response.EnsureSuccessStatusCode();
        }
        ...
        public async Task UpdatePoste(Poste poste)
        {
            ...
            var posteFormated = JsonConvert.SerializeObject(poste);
            var content = new StringContent(posteFormated, Encoding.UTF8, "application/json");
            var response = await _httpClient.PutAsync($"https://localhost:7011/api/Postes/{poste.Id}", content);
            response.EnsureSuccessStatusCode();
        ...
        public async Task DeletePoste(int posteId)
        {
            ...
            var response = await _httpClient.DeleteAsync($"https://localhost:7011/api/Postes/{posteId}");
            response.EnsureSuccessStatusCode();
