...
namespace PR3_Blazor_Mud.Components.Services
{
...

    {
        ...
        public async Task<Salle> GetSalleById(int salleId) {
            ...
            HttpResponseMessage response = await _httpClient.GetAsync($"https://localhost:7011/api/Salles/{salleId}");
            response.EnsureSuccessStatusCode();
        ...
        public async Task AddSalle(Salle salle)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:7011/api/Salles");
        ...
        public async Task UpdateSalle(Salle salle)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Put, $"https://localhost:7011/api/Salles/{salle.Id}");
            request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        public async Task DeleteSalle(int salleId)
        {
            ...
            var response = await _httpClient.DeleteAsync($"https://localhost:7011/api/Salles/{salleId}");
            response.EnsureSuccessStatusCode();
